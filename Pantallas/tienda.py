...
def agregar_al_carrito(nombre, precio, carrito):
...
def abrir_tienda(root):
    ...
    frame_tree.place(x=150, y=70, width=700, height=300)
    ...
    for producto in productos:
        ...
        boton_agregar = tk.Button(tienda_ventana, text="Agregar",command=lambda nombre=producto['nombre'],
        precio=producto['precio']: agregar_al_carrito(nombre, precio, carrito),bg="white", fg="#B90518", width=6,
        font=fuente_personalizada,padx=5, pady=0)
        boton_agregar.place(x=580, y=100 + 30 * productos.index(producto))  # Colocar el botón al lado del producto
